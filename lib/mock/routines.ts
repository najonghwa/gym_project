...
export const EXPLORE: ExploreRoutine[] = [
  ...
  { id: "ss", badge: "SS", title: "스타팅 스트렝스", desc: "마크 리피토의 교과서 3×5",
    ...
    target: "전신", equipment: "바벨", level: "초급", muscles: ["legs", "chest", "back"], exercises: ["back_squat", "bench_press", "seated_row"], likes: 87, weeks: 12, daysPerWeek: 3, durationMin: 40, kcal: "230~350" },
  { id: "phul", badge: "PH", title: "PHUL 4일 분할", desc: "힘의 날 + 펌핑의 날 반반",
    ...
    target: "전신", equipment: "바벨+머신", level: "중급", muscles: ["chest", "back", "legs", "shoulders"], exercises: ["bench_press", "seated_row", "back_squat", "lat_pulldown"], likes: 74, weeks: 12, daysPerWeek: 4, durationMin: 60, kcal: "350~480" },
  { id: "gvt", badge: "GV", title: "GVT 10×10 (독일식 볼륨)", desc: "한 운동 10세트×10회, 벌크의 클래식",
    ...
    target: "전신", equipment: "바벨", level: "고급", muscles: ["chest", "back", "legs"], exercises: ["bench_press", "seated_row", "back_squat", "db_shoulder_press"], likes: 45, weeks: 6, daysPerWeek: 4, durationMin: 55, kcal: "400~520" },
  { id: "five31", badge: "53", title: "5/3/1 (짐 웬들러)", desc: "4주 파도로 끝없이 강해지기",
    ...
    target: "전신", equipment: "바벨", level: "중급", muscles: ["shoulders", "legs", "chest", "back"], exercises: ["db_shoulder_press", "back_squat", "bench_press", "lat_pulldown"], likes: 69, weeks: 16, daysPerWeek: 4, durationMin: 50, kcal: "300~430" },
  { id: "texas", badge: "TX", title: "텍사스 메소드", desc: "볼륨 → 회복 → 금요일 신기록",
    ...
    target: "전신", equipment: "바벨", level: "중급", muscles: ["legs", "chest", "shoulders"], exercises: ["back_squat", "bench_press", "db_shoulder_press"], likes: 38, weeks: 12, daysPerWeek: 3, durationMin: 55, kcal: "320~450" },
  { id: "bro", badge: "BR", title: "브로 스플릿 5분할", desc: "하루 한 부위, 헬스장의 클래식",
    ...
    target: "전신", equipment: "바벨+머신", level: "중급", muscles: ["chest", "back", "shoulders", "legs", "biceps"], exercises: ["bench_press", "lat_pulldown", "db_shoulder_press", "back_squat", "barbell_curl"], likes: 91, weeks: 8, daysPerWeek: 5, durationMin: 60, kcal: "380~500" },
  { id: "arnold", badge: "AN", title: "아놀드 스플릿", desc: "아놀드의 3분할 × 주 2바퀴",
    ...
    target: "전신", equipment: "바벨+덤벨", level: "고급", muscles: ["chest", "back", "shoulders", "biceps", "legs"], exercises: ["bench_press", "lat_pulldown", "db_shoulder_press", "barbell_curl", "back_squat"], likes: 63, weeks: 8, daysPerWeek: 6, durationMin: 70, kcal: "450~600" },
  { id: "smolov", badge: "SM", title: "스모로프 Jr (벤치 특화)", desc: "3주 만에 벤치 +5~10kg",
    ...
    target: "상체", equipment: "바벨", level: "고급", muscles: ["chest", "triceps"], exercises: ["bench_press", "seated_row"], likes: 29, weeks: 3, daysPerWeek: 4, durationMin: 45, kcal: "280~380" },
];
